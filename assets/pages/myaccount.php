...
/*header('Content-Type: text/html; charset=utf-8'); // Добавлен HTTP заголовок для UTF-8
session_start();
...
try {
    ...
    $pdo->exec("set names utf8mb4 collate utf8mb4_general_ci"); // Явное указание кодировки и сопоставления
